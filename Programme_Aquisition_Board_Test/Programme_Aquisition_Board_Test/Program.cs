    ...
    class Program
    {
        static void Main(string[] args)
        {
            try
            {
                ...
                //bool config_ok = acqBoardConfiguration.Set_Histogram_8bits(1, 0, 1500.0, 1, false, false);



                //bool config_ok = acqBoardConfiguration.Set_Correlation_8bits(2, 0, 1500.0, false, false, 1);

                //bool config_ok = acqBoardConfiguration.Set_Auto_Correlation_8bits(2, 0, 1, true, 1500.0, false, false, 1);

                //bool config_ok = acqBoardConfiguration.Set_Auto_Correlation_8bits(2, 0, 2, true, 1500.0, false, false, 1);

                //bool config_ok = acqBoardConfiguration.Set_Auto_Correlation_8bits(2, 0, 1, false, 1500.0, false, false, 1);

                //bool config_ok = acqBoardConfiguration.Set_Auto_and_Coor_8bits(2, 0, 1, false, 1500.0, false, false, 1);
